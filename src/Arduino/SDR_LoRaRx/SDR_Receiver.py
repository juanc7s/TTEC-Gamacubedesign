...
class SDR_Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._refr_range = Range(0.00001, 0.001, 0.00001, 0.0005, 200)
        self._refr_win = RangeWidget(self._refr_range, self.set_refr, "'refr'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._refr_win)
        self._freq_range = Range(410e6, 443e6, 1e6, 434e6, 200)
        ...
        self.qtgui_freq_sink_x_0.set_update_time(refr)
        self.qtgui_freq_sink_x_0.set_y_axis((-140), 10)
        self.qtgui_freq_sink_x_0.set_y_label('Relative Gain', 'dB')
        self.qtgui_freq_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_AUTO, -40.0, 0, "")
    ...
    def set_refr(self, refr):
        self.refr = refr
        self.qtgui_freq_sink_x_0.set_update_time(self.refr)
