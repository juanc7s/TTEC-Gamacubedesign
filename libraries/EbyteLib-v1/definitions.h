...
enum IO_DRIVE_MODE{
  IO_DRIVE_MODE_PUSH_PULL = 0b1,
  IO_DRIVE_MODE_OPEN_COLLECTOR = 0b0
};

enum WIRELESS_WAKE_UP_TIME{
  WIRELESS_WAKE_UP_TIME_250ms = 0b000,
  WIRELESS_WAKE_UP_TIME_500ms = 0b001,
  WIRELESS_WAKE_UP_TIME_750ms = 0b010,
  WIRELESS_WAKE_UP_TIME_1000ms = 0b011,
  WIRELESS_WAKE_UP_TIME_1250ms = 0b100,
  WIRELESS_WAKE_UP_TIME_1500ms = 0b101,
  WIRELESS_WAKE_UP_TIME_1750ms = 0b110,
  WIRELESS_WAKE_UP_TIME_2000ms = 0b111
};
